...
urlpatterns = [
    ...
    re_path(r'^task/questionnaire/detail/(?P<t_id>\d+)$', task.task_questionnaire_detail),
    path('task/acceptance', task.task_acceptance),
    path('task/delivery/complishment', task.task_delivery_complishment),
    re_path(r'^task/delivery/(?P<t_id>\d+)$', task.task_delivery_delete),
    ...
    re_path(r'^task/questionnaire/answerSheet/(?P<q_id>\d+)$', task.task_questionnaire_answerSheet),
    re_path(r'^task/questionnaire/Statistics/(?P<q_id>\d+)$', task.task_questionnaire_Statistics),
